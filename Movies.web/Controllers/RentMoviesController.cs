        ...
        public ActionResult Index()
        {
            IEnumerable<Movie> RentMovie = new List<Movie>() {
                   ...
                   new Movie
              {
                  ...
                  Genre="Fiction",
                  Duration="2h 32m",
                  Relase_date= Convert.ToDateTime("14/11/2001"),
                  Rating="PG-MPAA",
                  Rent_price=50,
                  Sale_price=130
                 ...
                 new Movie
              {
                  ...
                  Genre="Fiction",
                  Duration="1h 57m",
                  Relase_date= Convert.ToDateTime("16/10/2020"),
                  Rating="PG-MPAA",
                  Rent_price=45,
                  Sale_price=130
                  ...
                  new Movie
              {
                  ...
                  Genre="Comedy",
                  Duration="1h 45m",
                  Relase_date= Convert.ToDateTime("28/07/2013"),
                  Rating="PG-MPAA",
                  Rent_price=45,
                  Sale_price=130
                   ...
                   new Movie
              {
                  ...
                  Genre="Romance/Drama",
                  Duration="3h 14m",
                  Relase_date= Convert.ToDateTime("19/12/1997"),
                  Rating="PG-MPAA",
                  Rent_price=50,
                  Sale_price=115
